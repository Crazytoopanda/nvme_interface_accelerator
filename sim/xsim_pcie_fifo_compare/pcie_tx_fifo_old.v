...
assign rd_data = r_mem[r_front_line[P_FIFO_DEPTH_WIDTH-1:0]];
...
begin
	if(wr_rst_n == 1'b0) begin
		...
		if(wr_en == 1'b1) begin
			r_mem[r_rear_line[P_FIFO_DEPTH_WIDTH-1:0]][w_wr_sel*P_FIFO_WR_DATA_WIDTH +: P_FIFO_WR_DATA_WIDTH] <= wr_data;
...
begin
	if(rd_rst_n == 1'b0) begin
		...
		r_rear_sync_addr_d1 <= r_rear_full_addr;
