...
static int print_auto_status(int fd)
{
	static const struct named_reg regs[] = {
		...
		{ "model_read_lsb_cycles", NVME_FW_REG_SSD_READ_LSB_CYCLES },
		{ "model_read_msb_cycles", NVME_FW_REG_SSD_READ_MSB_CYCLES },
		{ "model_program_cycles", NVME_FW_REG_SSD_PROGRAM_CYCLES },
		{ "model_fw_read_cycles", NVME_FW_REG_SSD_FW_READ_CYCLES },
		{ "model_fw_write_cycles", NVME_FW_REG_SSD_FW_WRITE_CYCLES },
		{ "model_ch_xfer_4k_cycles", NVME_FW_REG_SSD_CH_XFER_4K_CYCLES },
