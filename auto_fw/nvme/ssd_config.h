 ...
 * base SSD does not require hand-maintained constants in auto_fw.c.
 */
#ifndef AUTO_FW_PCIE_USER_CLOCK_HZ
#define AUTO_FW_PCIE_USER_CLOCK_HZ (250000000ULL)
#endif

#define SSD_DIV_ROUND_UP(n, d) (((n) + (d) - 1ULL) / (d))
#define SSD_NS_TO_PCIE_CYCLES(ns) \
	SSD_DIV_ROUND_UP((ns) * AUTO_FW_PCIE_USER_CLOCK_HZ, 1000000000ULL)

/* Match nvmevirt/channel_model.c: 128-byte units and integer xfer latency. */
#define SSD_CH_UNIT_XFER_BYTES (128ULL)
#define SSD_CH_UNIT_XFER_NS \
	((SSD_CH_UNIT_XFER_BYTES * 1000000000ULL) / MB(NAND_CHANNEL_BANDWIDTH))
#define SSD_CH_XFER_4KB_UNITS \
	SSD_DIV_ROUND_UP(KB(4), SSD_CH_UNIT_XFER_BYTES)
#define SSD_CH_XFER_4KB_NS \
	((SSD_CH_UNIT_XFER_NS * SSD_CH_XFER_4KB_UNITS) + FW_CH_XFER_LATENCY)

#define AUTO_FW_SSD_READ_LSB_CYCLES \
	SSD_NS_TO_PCIE_CYCLES(NAND_4KB_READ_LATENCY_LSB)
#define AUTO_FW_SSD_READ_MSB_CYCLES \
	SSD_NS_TO_PCIE_CYCLES(NAND_4KB_READ_LATENCY_MSB)
#define AUTO_FW_SSD_PROGRAM_CYCLES \
	SSD_NS_TO_PCIE_CYCLES(NAND_PROG_LATENCY)
#define AUTO_FW_SSD_FW_READ_CYCLES \
	SSD_NS_TO_PCIE_CYCLES(FW_4KB_READ_LATENCY)
#define AUTO_FW_SSD_FW_WRITE_CYCLES \
	SSD_NS_TO_PCIE_CYCLES(FW_WBUF_LATENCY0 + FW_WBUF_LATENCY1)
#define AUTO_FW_SSD_CH_XFER_4K_CYCLES \
	SSD_NS_TO_PCIE_CYCLES(SSD_CH_XFER_4KB_NS)
