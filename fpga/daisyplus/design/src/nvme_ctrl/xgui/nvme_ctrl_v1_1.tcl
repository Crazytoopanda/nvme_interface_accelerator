...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S1_AXI_ADDR_WIDTH"
  ipgui::add_param $IPINST -name "C_S1_AXI_DATA_WIDTH" -widget comboBox
  ipgui::add_param $IPINST -name "C_S1_AXI_ID_WIDTH"
  ipgui::add_param $IPINST -name "C_S1_AXI_BASEADDR"
  ipgui::add_param $IPINST -name "C_S1_AXI_HIGHADDR"
...
proc update_PARAM_VALUE.C_S1_AXI_ADDR_WIDTH { PARAM_VALUE.C_S1_AXI_ADDR_WIDTH } {
	# Procedure called to update C_S1_AXI_ADDR_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S1_AXI_ADDR_WIDTH { PARAM_VALUE.C_S1_AXI_ADDR_WIDTH } {
	# Procedure called to validate C_S1_AXI_ADDR_WIDTH
	return true
}

proc update_PARAM_VALUE.C_S1_AXI_BASEADDR { PARAM_VALUE.C_S1_AXI_BASEADDR } {
	# Procedure called to update C_S1_AXI_BASEADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S1_AXI_BASEADDR { PARAM_VALUE.C_S1_AXI_BASEADDR } {
	# Procedure called to validate C_S1_AXI_BASEADDR
	return true
}

proc update_PARAM_VALUE.C_S1_AXI_DATA_WIDTH { PARAM_VALUE.C_S1_AXI_DATA_WIDTH } {
	# Procedure called to update C_S1_AXI_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S1_AXI_DATA_WIDTH { PARAM_VALUE.C_S1_AXI_DATA_WIDTH } {
	# Procedure called to validate C_S1_AXI_DATA_WIDTH
	return true
}

proc update_PARAM_VALUE.C_S1_AXI_HIGHADDR { PARAM_VALUE.C_S1_AXI_HIGHADDR } {
	# Procedure called to update C_S1_AXI_HIGHADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S1_AXI_HIGHADDR { PARAM_VALUE.C_S1_AXI_HIGHADDR } {
	# Procedure called to validate C_S1_AXI_HIGHADDR
	return true
}

proc update_PARAM_VALUE.C_S1_AXI_ID_WIDTH { PARAM_VALUE.C_S1_AXI_ID_WIDTH } {
	# Procedure called to update C_S1_AXI_ID_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S1_AXI_ID_WIDTH { PARAM_VALUE.C_S1_AXI_ID_WIDTH } {
	# Procedure called to validate C_S1_AXI_ID_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_S1_AXI_ID_WIDTH { MODELPARAM_VALUE.C_S1_AXI_ID_WIDTH PARAM_VALUE.C_S1_AXI_ID_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S1_AXI_ID_WIDTH}] ${MODELPARAM_VALUE.C_S1_AXI_ID_WIDTH}
}
