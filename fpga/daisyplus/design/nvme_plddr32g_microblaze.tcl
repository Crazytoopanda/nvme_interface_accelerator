...
#
# nvme_plddr32g_microblaze.tcl: Tcl script for re-creating project 'nvme_plddr32g_microblaze'
#
# Generated by Vivado on Fri Jul 24 09:57:29 CST 2026
...
#
# 1. This project restoration tcl script (nvme_plddr32g_microblaze.tcl) that was generated.
#
...
#
#    "/home/lfa/nvme_interface_accelerator/fpga/daisyplus/design/src/qkv_acc_top_x1dimm.v"
#    "/home/lfa/nvme_interface_accelerator/fpga/daisyplus/constraints/microblaze/pcie.xdc"
#    "/home/lfa/nvme_interface_accelerator/fpga/daisyplus/constraints/microblaze/plddr4_dimmx1.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/qkv_acc_top_x1dimm.v"]"\
 "[file normalize "$origin_dir/../../constraints/microblaze/pcie.xdc"]"\
 "[file normalize "$origin_dir/../../constraints/microblaze/plddr4_dimmx1.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../../[file normalize "$origin_dir/nvme_ctrl"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "nvme_plddr32g_microblaze"
...
set script_file "nvme_plddr32g_microblaze.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../nvme_plddr32g_microblaze"]"
...
set_property -name "compxlib.ies_compiled_library_dir" -value "/home/lfa/nvme_interface_accelerator/fpga/daisyplus/design/nvme_plddr64g_microblaze/nvme_plddr64g_microblaze.cache/compile_simlib/ies" -objects $obj
...
set_property -name "sim.ipstatic.compiled_library_dir" -value "/home/lfa/nvme_interface_accelerator/fpga/daisyplus/design/nvme_plddr64g_microblaze/nvme_plddr64g_microblaze.cache/compile_simlib/xsim/ip" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/nvme_ctrl"]" $obj
...
set file "$origin_dir/qkv_acc_top_x1dimm.v"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../constraints/microblaze/plddr4_dimmx1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../constraints/microblaze/plddr4_dimmx1.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_JITTER {89.645} \
    CONFIG.CLKOUT1_PHASE_ERROR {83.950} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {250.000} \
    CONFIG.CLKOUT2_DRIVES {BUFG} \
    CONFIG.CLKOUT2_JITTER {98.411} \
    CONFIG.CLKOUT2_PHASE_ERROR {83.950} \
...
if { [get_property IS_LOCKED [ get_files -norecurse [list qkv_accelerator.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../nvme_plddr32g_microblaze/nvme_plddr32g_microblaze.gen/sources_1/bd/qkv_accelerator/hdl/qkv_accelerator_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/nvme_plddr32g_microblaze.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/nvme_plddr32g_microblaze.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/nvme_plddr32g_microblaze.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
